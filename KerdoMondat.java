 ...
 * @author bodnart
 */
public class KerdoMondat {
    
/**
*Ebben az osztályban a kérd?jelre végz?d? mondatokat manipuláljuk.
...
*/
     ...
     public  static StringBuilder kerdoMondat() {
                String subMondattxt;
                if (textSB.charAt(0) == ' '){
                ...
                String subMondatTxt = textSB.substring(0, kJel+1);
                subMondattxt = subMondatTxt;
                ...
                textSB1 = new StringBuilder(textSB.delete(0, kJel+1));
                textSB = textSB1;
